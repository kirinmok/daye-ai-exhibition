...
### KIRIN 後續追加的 v2 改裝項目（2026-06-14 13:57）

這些都是 v2 改裝系統的核心，跟「關卡解鎖式改造」搭配最強：

#### 🔧 馬達系統
- **單馬達 vs 雙馬達**：差速轉彎概念（雙馬達兩邊獨立控速 → 過彎強）
- 單馬達馬力有限、無法純電子差速 → **皮帶傳動**讓車變四驅
- 教學連結：阿基米德差速器、CVT 變速、坦克履帶轉向原理
- 視覺差異：單馬達車身只有一顆 M、雙馬達兩顆 M、皮帶四驅有外露皮帶輪

#### 🦴 車殼系統（新軸 "shell"）
建議三選一：
- **封閉車殼**（預設）：流線、防水、適合街道
- **骨架越野**：外露金屬框架、無門、適合泥地/淹水（露管可以排水）
- **載貨車斗**（pickup）：後段開放、可載物資、續航差但實用

#### 🛒 任務模組（新軸 "cargo"）
- **空車**：最輕、最快
- **小貨斗**：載 5 包早餐 / 救援物資
- **大貨斗**：載 20 包但拖累速度
- 連結救災敘事：「水城工程聯盟」徵召的就是運物資的工程師
