...
function buildForm() {
  ...
  // ===== 第 4 區：專業評選投票（只剩 2 個獎，其餘 3 個交給觀眾票決定）=====
  form.addPageBreakItem()
    .setTitle('\u{1F3C6} 第 4 區｜專業評選投票')
    .setHelpText('🥇 人氣、🎨 畫面、🕹️ 玩法 這 3 個獎由觀眾票決定（觀眾感受最直接、最公平）。\n你在這裡只投 💡 創意 + 🚀 潛力 2 個獎 — 這兩個獎需要看 prompt、看程式、看製作邏輯，社員才有資格判斷。');

  [
    '\u{1F4A1} 最佳創意概念獎（主題 / 玩法 / 視覺有新鮮感，AI 共創痕跡明顯）',
    '\u{1F680} 最具潛力獎（概念完整、議題有延伸性，值得繼續開發）'
  ].forEach(title => {
    form.addListItem()
      .setTitle(title)
