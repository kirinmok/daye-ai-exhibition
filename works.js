const EVENT_CONFIG = {
  ...
  purpose: "學生把 AI 視覺變成一款款可玩的遊戲，現在換你當評審。進場試玩、挑戰、投票，選出你最想推薦的作品。人氣王，由觀眾決定。",
  votingRule: "6/15（一）～ 6/19（五）開放線上票選。先進作品頁試玩，再點「投這件當人氣王」送出你的支持；每個 Google 帳號可填答 1 次，也可以留下給作者的真實建議。",
  participationValue: "你投下的不是普通一票，而是把喜歡的作品推向人氣獎；你留下的一句建議，也會成為作者修玩法、修畫面、修操作的下一步線索。",
