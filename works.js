const EVENT_CONFIG = {
  ...
  purpose: "讓學生的 AI 視覺與遊戲作品走出課堂，接受真實觀眾試玩、票選與回饋，學會把創意整理成可以被理解、被支持、也能繼續改進的作品。",
  votingRule: "展期 6/15（一）～ 6/19（五）。觀眾請先試玩作品，再到作品詳情頁點「投這件當人氣王」，每個 Google 帳號可填答 1 次，選出最想支持的作品並留下具體建議。",
  participationValue: "你的投票會影響人氣獎，你的建議會回到作者手上，成為學生修正玩法、畫面、操作與作品介紹的下一步依據。",
